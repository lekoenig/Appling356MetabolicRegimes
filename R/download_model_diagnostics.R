...
#'
#'
download_model_diagnostics <- function(){
  ...
  unzip(zipfile = paste(temp,"/diagnostics.zip",sep=""),exdir = temp)
  model_diagn_df <- read.csv(paste(temp,"/diagnostics.tsv",sep=""), sep = "\t",header=TRUE)
